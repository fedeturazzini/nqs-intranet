/**
 * POST /api/tools/kling/request-credits
 *
...
export async function POST(request: Request): Promise<NextResponse> {
  ...
  // Notif a Slack — no bloquea ni puede romper la request. Usamos
  // /admin/requests (la ruta real; el de 3DSky tenía /admin#requests, ver
  // slack-audit.md D2).
