 ...
 *
 * Mantener sincronizado con los modelos vigentes (migration 0019):
...
const PRICING: Record<string, { input: number; output: number }> = {
  ...
  // Sonnet 5: mismo pricing estándar que 4.6 ($3/$15). Tiene intro $2/$10 hasta
  // 2026-08-31, pero usamos el estándar para no subestimar el costo después.
